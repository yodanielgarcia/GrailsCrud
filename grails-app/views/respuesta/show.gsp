...
<html>
    ...
    <body>
        ...
        <div id="show-respuesta" class="content scaffold-show" role="main">
            ...
            <f:display bean="respuesta" />
            <g:form resource="${this.respuesta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.respuesta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
